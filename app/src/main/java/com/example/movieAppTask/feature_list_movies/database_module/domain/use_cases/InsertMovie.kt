...
class InsertMovie @Inject constructor(val moviesDBRepository: MoviesDBRepository) {
    suspend operator fun invoke(movieModel: MovieModel) = moviesDBRepository.insertMovies(movieModel)
